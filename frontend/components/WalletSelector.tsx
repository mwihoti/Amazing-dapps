  ...
  return connected ? (
        ...
        {wallet && isAptosConnectWallet(wallet) && (
          <DropdownMenuItem asChild>
            <a href={APTOS_CONNECT_ACCOUNT_URL} target="_blank" rel="noopener noreferrer" className="flex gap-2">
              <User className="h-4 w-4 bg-slate-900 " /> Account
            </a>
          </DropdownMenuItem>
        )}
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogTrigger asChild>
        <Button className="bg-emerald-700 w-auto">Connect a Wallet</Button>
      </DialogTrigger>
...
function ConnectWalletDialog({ close }: ConnectWalletDialogProps) {
  ...
  return (
    <DialogContent className="max-h-screen overflow-auto bg-slate-400">
